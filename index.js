...
app.use('/uploads/reportes', express.static(path.join(__dirname, 'uploads/reportes')));// Verificar conexión a la base de datos al iniciar
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        console.warn('Advertencia al expirar compras_areas_personas:', errExp.message);
      }
